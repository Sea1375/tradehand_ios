...
<template>
    <f7-page @page:init="pageLoad">
        <f7-navbar :back-link="true" :title="trans('modules.client.addNewClient')" sliding layout="dark" theme="white">
...
<script type="text/babel">
    ...
    import ModuleMixin from "../client/mixin";
        ...
        methods: {
            init () {
                ...
                Promise.all(promises).then(() => {
                    ...
                    // this.item.client_detail.sub_category =  this.allSubCategories[0];
            ...
            submit() {
                ...
                this.$http.post(`/client`, this.item).then((response) => {
                    this.$f7.preloader.hide();
