<template>
    <f7-page infinite @infinite="onInfiniteScroll" ptr @ptr:refresh="refresh" :infinite-preloader="infiniteScrollInProgress" @page:init="pageLoad">
        ...
        <f7-navbar :sliding="false">
            ...
            <f7-nav-right>
                <f7-link href="#" sheet-open=".lead-filter" icon-f7="slider_horizontal_3"></f7-link>
            </f7-nav-right>
        </f7-navbar>
        ...
        <f7-fab position="right-bottom" slot="fixed" href="/lead/create" color="blue">
    ...
    export default {
        ...
        methods: {
            ...
            getFilters () {
                ...
                if (this.item.lead_agent.id !== 0 && this.item.lead_agent.id !== null) {
                    filters += `agent_id eq "${ this.item.lead_agent.id }" and `;
                }
            ...
            apply() {
                this.$f7.sheet.get('.lead-filter').close();
                this.init();
            },
